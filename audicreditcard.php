...
if($_SESSION['status']==true)
{
 ...
 $total = $_SESSION['aprice'];
$_SESSION['apay_mode']='creditcard';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
     ...
     <div class="screen flex-center">
          <form class="popup flex p-lg" action="audiconfirmation.php" method="POST">
               ...
               <div class="flex-fill flex-vertical">
                    ...
                    <div class="action flex-center">
                         ...
                         <button type="submit" class="b-main-color pointer" name=paynow>Pay Now</button>
                    </div>
               </div>
